import { addDays, startOfWeek, endOfWeek, startOfMonth, endOfMonth, isSameDay, isSameMonth, format, } from "date-fns";
...
export function getWeekLabel(days) {
