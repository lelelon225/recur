...
function ArchiveSelectionToolbar({ selectMode, selectedCount, allSelected, onEnterSelectMode, onExitSelectMode, onToggleAllSelected, onRequestBulkDelete, }) {
    if (!selectMode) {
        return (<div className="flex items-center justify-between gap-4 px-4 pt-4">
        <div />
    ...
    return (<div className="flex items-center justify-between gap-4 px-4 pt-4">
      ...
      <div className="flex items-center gap-2">
        {selectedCount > 0 && (<Button variant="destructive" size="sm" onClick={onRequestBulkDelete}>
